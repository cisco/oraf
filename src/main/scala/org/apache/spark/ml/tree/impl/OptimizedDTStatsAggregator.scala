...
/**
  ...
  */
class OptimizedDTStatsAggregator(
                                        val metadata: OptimizedDecisionTreeMetadata,
  ...
  /**
    ...
    *       categorical features, because the parent [[org.apache.spark.ml.tree.Node]] object does not have [[org.apache.spark.mllib.tree.model.ImpurityStats]]
  ...
  /**
    ...
    */
  def merge(other: OptimizedDTStatsAggregator): OptimizedDTStatsAggregator = {
