...
class OptimizedNodeIdCache(
  ...
  def updateNodeIndices(
      data: RDD[BaggedPoint[OptimizedTreePoint]],
...
object OptimizedNodeIdCache {
  ...
  def init(
      ...
      initVal: Int = 1): OptimizedNodeIdCache = {
    new OptimizedNodeIdCache(
