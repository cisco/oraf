...
import org.apache.spark.ml.tree.{OptimizedLearningNode, Split}
...
private[impl] case class TrainingInfo(
                                       ...
                                       currentLevelActiveNodes: Array[OptimizedLearningNode],
   ...
   */
  def update(splits: Array[Array[Split]],
             newActiveNodes: Array[OptimizedLearningNode]): TrainingInfo = {
